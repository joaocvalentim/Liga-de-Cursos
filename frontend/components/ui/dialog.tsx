...
// se não tiveres este helper, cria em `frontend/lib/utils.ts`:
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid w-full max-w-lg gap-4 rounded-xl border bg-white p-6 shadow-lg",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 rounded-md p-1 text-gray-500 hover:bg-gray-100">
        <X className="h-4 w-4" />
